...
urlpatterns = [
    ...
    url(r'^administrator/bill/edititem', views.admin_edit_item, name='admin_edit_item'),
    url(r'^administrator/bill/newitem', views.admin_new_item, name='admin_new_item'),
    url(r'^administrator/bill/view', views.admin_bill_view, name='admin_bill_view'),
    url(r'^administrator/bill/(\w+)', views.admin_bill_all, name='admin_bill_all'),
    url(r'^administrator/payment-method/$', views.admin_payment_method, name='admin_payment_method'),
    url(r'^administrator/payment-method/multipayment/$', views.admin_payment_method_multipayment, name='admin_payment_method_multipayment'),
